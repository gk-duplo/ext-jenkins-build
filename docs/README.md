...
The authoring manual is the 18 numbered guides in
...
error handling, opt-in Ask AI sessions, and custom tabbed result views. They are the source of truth, and the `/duplo-extension` authoring command reads them
directly.
