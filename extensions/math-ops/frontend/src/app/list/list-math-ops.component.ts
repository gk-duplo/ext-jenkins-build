...
import { MathOpsService, MathOps, REMOTE_UserSession } from '../math-ops.service';
...
export class ListMathOpsComponent implements OnInit {
  ...
  private readonly allRows = signal<MathOps[]>([]);
