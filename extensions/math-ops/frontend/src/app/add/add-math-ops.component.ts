    ...
    <div class="card panel-form-accordion">
      <div class="d-flex justify-content-between">
        ...
        <div class="panel-content-title">
          <h4 class="font-weight-bolder">Create Math Ops</h4>
          <p class="panel-content-title-sub-text text-muted">
            Enter two numbers. A background worker computes all mathematical operations between them.
          </p>
        </div>

        <div class="panel-content-form">
          <form name="AddMathOpsForm" #f="ngForm" class="form form-vertical" (ngSubmit)="f.valid && submit()">
            <div class="form-container" form-group-errors #formGroupErrors showDetailsWhen="submitted">
              <form-field>
                ...
                <input type="text" class="form-control" name="name"
                       ...
                       placeholder="e.g. mathop-1" required validation-state validation-errors
        ...
        <div class="panel-content-sidenav">
          <div class="help-item">
            ...
            <small class="text-muted">The worker computes sum, difference, product, quotient, remainder, power, min, max and average. Quotient/remainder are null when B = 0.</small>
          </div>
        </div>
...
export class AddMathOpsComponent {
